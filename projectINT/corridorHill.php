...
<head>
  ...
  <title>Corridor Hill Residence</title>
  <style>
    body {
    ...
    .residence-img {
      width: 300px;
      height: 200px;
      background: url('corridor.jpg') center/cover no-repeat;
      border-radius: 10px;
...
<body>
  ...
  <div class="header">Corridor Hill Residence</div>

  <div class="residence-img"></div>

  <div class="info-section">
    <p><strong>Corridor Hill</strong> is a privately-managed residence for <strong>TUT students</strong> with easy access to campus.</p>
    <h3>Accommodation Details:</h3>
    <ul>
      <li><strong>Double-sharing rooms</strong> only</li>
      <li><strong>No single rooms</strong> available</li>
    </ul>

    <h3>Rules & Amenities:</h3>
    <ul>
      <li>Shared fridge per unit; students may bring a bar fridge</li>
    ...
    <h3>Capacity:</h3>
    <ul>
      <li><strong>Total beds</strong>: 1600+</li>
      <li><strong>Female</strong>: 800 | <strong>Male</strong>: 400 | <strong>Other/Reserved</strong>: 400</li>
    </ul>
  </div>
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3589.5208048616337!2d29.268491975404526!3d-25.88524447727448!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1eeaf2fa29948f49%3A0x76cf854961712f83!2sCorridor%20Hill!5e0!3m2!1sen!2sza!4v1745844654324!5m2!1sen!2sza" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

  <div class="footer">
    <p>© 2025 Corridor Hill Residence | All Rights Reserved</p>
    <small>Designed by Your Team Name</small>
  </div>

  <script>
    function fetchRooms() {
      fetch('get_rooms.php?residence=corridorhill')
        .then(res => res.json())
        .then(data => {
